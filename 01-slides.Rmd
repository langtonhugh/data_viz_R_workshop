...
All materials for today are available [online](https://github.com/langtonhugh/data_viz_workshop).

Link: https://github.com/langtonhugh/data_viz_workshop
...
```{r, echo=FALSE, out.height="450px", fig.show="hold"}
...
- Spatial visualisation necessitates some additional level of understanding in geography and Geographic Information Systems (GIS)
  - Spatial data
  - Projection
