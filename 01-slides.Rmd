...
knitr::include_graphics("img/covid_ft.png")
```

Source: [John Burn-Murdoch](https://twitter.com/jburnmurdoch/status/1332233679704383488/photo/1)
...
knitr::include_graphics("img/covid_map.png")
```
...
Source: [Thames Valley Police](place_holder)
