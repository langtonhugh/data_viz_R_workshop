...
Next, we'll create the classes. Recall that we have information about burglary and deprivation for each LSOA in the city of Manchester. If you saved and loaded in the data, the variable names may have been truncated, an irritating [feature of shapefiles](https://support.esri.com/en/technical-article/000022868), but it should be fairly clear what is what. In my data, we have `brglry_` (the burglary count for January 2017) and `incscore` (the income component of the deprivation measure). What might the relationship be between these variables, and how might it vary spatially across Manchester?
