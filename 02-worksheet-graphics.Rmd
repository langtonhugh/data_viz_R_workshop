...
The folks over at [Trafford Data Lab](https://www.trafforddatalab.io/) wrote a useful [blog](https://medium.com/@traffordDataLab/developing-a-data-visualisation-style-cd24f88fa59) about how to develop your own data visualisation style, and save themes as functions to be re-used. Many people even post their [custom themes](https://gist.github.com/jslefche/eff85ef06b4705e6efbc) online which you can use as a base to develop your own.
...
Let's first assign some basic graphics to objects. by way of an example. The below assumes that you have loaded in our two example data sets! Remember that you may have names your objects differently to me.
...
We can then arrange these plots using `plot_grid()` and a few optional extra arguments.
